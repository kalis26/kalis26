    ...
    if request.status_code == 200:
        if count_type == 'repos':
            ...
            if repositories['pageInfo']['hasNextPage']:
                return total_stars + graph_repos_stars(count_type, owner_affiliation, repositories['pageInfo']['endCursor'])
            return total_stars
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    justify_format(root, 'age_data', age_data, 89)
    justify_format(root, 'commit_data', commit_data, 34)
    justify_format(root, 'star_data', star_data, 48)
    justify_format(root, 'repo_data', repo_data, 13)
    justify_format(root, 'contrib_data', contrib_data)
    justify_format(root, 'follower_data', follower_data, 39)
    justify_format(root, 'loc_data', loc_data[2], 28)
    justify_format(root, 'loc_add', loc_data[0], 22)
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2006, 4, 24))
